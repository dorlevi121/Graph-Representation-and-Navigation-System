...
public class Ex4_Client implements Runnable{
	...
	public void run() {
		...
		int rs = 0;
		try {
			line = new JSONObject(res);
			JSONObject ttt = line.getJSONObject("GameServer");
			 rs = ttt.getInt("game_level");
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		
		File file = new File("/home/dor/eclipse-workspace/Ex4_v0.31/data/0.kml");
		...
		String remark = "";
		game.sendKML(fileContents.toString()); // Should be your KML (will not work on case -1).
